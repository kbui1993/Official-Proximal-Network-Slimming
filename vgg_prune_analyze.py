...
parser.add_argument('--name', default='vggnet', type=str,
...
data = [args.model, 'VGG', args.depth, args.dataset, num_parameters, num_channels_pruned, channel_percentage, 1.0-num_parameters/total_parameters, 1-flops/total_flops, checkpoint['best_prec1'].item(), pruned_acc.item()]
